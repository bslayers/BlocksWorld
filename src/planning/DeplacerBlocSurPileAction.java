...
public class DeplacerBlocSurPileAction extends BasicAction {
    private int b;
    private int p;

    public DeplacerBlocSurPileAction(BlocksWorldVariable blocksWorldVariable, int b, int p, int cost) {
    ...
    public String toString() {
        return "Déplacer le bloc " + this.b + " sur la pile " + this.p;
    }
}